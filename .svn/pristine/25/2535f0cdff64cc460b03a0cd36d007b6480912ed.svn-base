...
<body>
	${errMsg}
	<div class="pd-20">
		<form action="${ctx }/student/enroll" method="post" class="form form-horizontal" id="form-member-add">
			<div class="row cl">
				<label class="form-label col-3"><span class="c-red">*</span>姓名：</label>
				<div class="formControls col-5">
					<input type="text" class="input-text" value="${stu.s_name }"
						placeholder="" id="member-name" name="name" datatype="*2-16"
						nullmsg="请输入姓名">
				</div>
				<div class="col-4"></div>
			</div>
			<input type="hidden" value="${stu.ac_id }" name="ac_id">
			<div class="row cl">
				<label class="form-label col-3"><span class="c-red">*</span>身份证号：</label>
				<div class="formControls col-5">
					<input type="text" class="input-text" value="${stu.s_pid }"
						name="idcard" placeholder="请仔细填写身份证号哦" datatype="idcard"
						nullmsg="请输入正确的身份证号">
				</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-5 skin-minimal">
					<div class="radio-box">
						<input type="radio" id="sex-1" value="1" name="gender"
							datatype="*" nullmsg="请选择性别！"> <label for="sex-1">男</label>
					</div>
					<div class="radio-box">
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" class="input-text" value="${stu.s_qq }"
						placeholder="" id="member-tel" name="qq" datatype="n6-15"
						nullmsg="请输入qq号">
				</div>
				<div class="col-4"></div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" class="input-text" value="${stu.s_id }"
						placeholder="" id="member-tel" name="id" datatype="n11-11"
						nullmsg="请输入11位学号">
				</div>
				<div class="col-4"></div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" class="input-text" value="${stu.s_phone }"
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" value="${stu.s_email }" class="input-text"
						placeholder="@" name="email" id="email" datatype="e"
						nullmsg="请输入邮箱！">
				</div>
				<div class="col-4"></div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" class="input-text" value="${stu.s_tname }"
						placeholder="" name="teacher" datatype="*2-16" nullmsg="请输入辅导员姓名">
				</div>
				<div class="col-4"></div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" class="input-text" value="${stu.s_tphone }"
						placeholder="" id="member-tel" name="t_phone" datatype="m"
						nullmsg="请输入电话号码">
				</div>
				<div class="col-4"></div>
			</div>
				...
				<div class="formControls col-5" style="width: 210px">
					<span class="select-box"> <select class="select" size="1"
						name="system" datatype="*" nullmsg="请选择所在系别！">
							<option value="${stu.s_department }" selected>${stu.s_departmentName }</option>
							<option value="1">数艺系</option>
							<option value="2">信管系</option>
							<option value="3">计科系</option>
							<option value="4">外语系</option>
					</select>
					</span>
				</div>
				...
				<div class="formControls col-5" style="width: 210px">
					<span class="select-box"> <select class="select" size="1"
						name="size" datatype="*" nullmsg="请选择衣服尺寸！">
							<option value="${stu.s_size }" selected>${stu.s_sizeName }</option>
					...
					<div class="formControls col-5" style="width: 210px">
						<span class="select-box"> <select class="select" id="team"
							size="1" name="team" datatype="*" nullmsg="请选择所在团队！">
								<option value="${stu.s_team }" selected>${stu.s_teamName }</option>
			...
			<div class="row cl">
				...
				<div class="formControls col-5">
					<textarea name="view" cols="" rows="" class="textarea"
						...
						dragonfly="true" onKeyUp="textarealength(this,100)">${stu.s_detail }</textarea>
 ...
 /*  $('.skin-minimal input').iCheck({
  ...
  $("#form-member-add").Validform({
    ...
    callback:function(form){
    	 document.getElementByIdx_x('form-member-add').submit();
    	 alert("sdfskldfa");
