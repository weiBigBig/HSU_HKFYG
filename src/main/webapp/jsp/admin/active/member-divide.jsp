...
<body>
	<div class="pd-20">
		<form action="" method="post" class="form form-horizontal"
			id="form-active-add">
			<div class="row cl">
				<label class="form-label col-2"><span class="c-red">*</span>剩余人数：</label>
				<div class="formControls col-6">
					<input type="text" class="input-text" value="=剩余总人数-组数*每组人数" placeholder="2-300"
						id="active-name" name="active-name" disabled="disabled"
						>
				</div>
				<div class="col-4"></div>
			</div>
			...
			<div class="row cl">
				<label class="form-label col-2"><span class="c-red">*</span>组数：</label>
				<div class="formControls col-6">
					<input type="text" class="input-text" value="" placeholder="2-300"
						id="active-name" name="active-name" datatype="n2-200"
						nullmsg="请输入组数">
				</div>
				<div class="col-4"></div>
			</div>
			...
			<div class="row cl">
				<label class="form-label col-2"><span class="c-red">*</span>每组人数：</label>
				<div class="formControls col-6">
